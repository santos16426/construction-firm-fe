...
const CTASection = () => {
  ...
  return (
    <section
      id="contact"
      className="py-40  bg-white bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[24px_24px]"
    >
