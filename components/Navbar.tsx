    ...
    <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
      ...
      <div className="hidden md:flex items-center gap-10">
          ...
          <a
            onClick={() => {
              if (item === "Services") {
                ...
                window.scrollTo({
                  top: document.getElementById("why-choose-us")?.offsetTop,
                  behavior: "smooth",
                });
              }
            }}
        ...
        <button
          ...
          className="bg-amber-500 text-slate-900 px-8 py-3 font-black text-[10px] uppercase tracking-widest rounded-full hover:bg-white transition-all shadow-lg"
        >
          Get Quote
        </button>
      </div>
